...
ここがdevinが爆走中に長時間の泥沼にはまったところ。　スタックしている出力をgeminiにコピペしてdevinへの指示を生成させ、一旦、devinを止めてgeminiの指示で続行させる方法で主は見てるだけ、あっちからこっち、こっちからあっちにコピペしてるだけ。　画面やウィンドウのスクショでもgeminiはこなすのでさらに楽。
